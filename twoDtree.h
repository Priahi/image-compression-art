...
#include <utility>
#include "../ppa3/cs221util/PNG.h"
#include "../ppa3/cs221util/RGBAPixel.h"
#include "stats.h"
using namespace std;
...
private:
   ...
   public:
    ...
    void renderHelper(Node * curr, PNG &img);
    Node* copyClearHelper(Node * curr, bool isCopy);
    RGBAPixel pruner(Node * curr, RGBAPixel avgValue);
    void pruneHelper(int tol, Node * curr);
    int pruneSizeHelper(int tol, Node * curr);
    int numLeaves(Node* curr, bool checkPrune, int tol, RGBAPixel av);
