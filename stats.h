...
private:
    //vectors store sum of rectangle color (total for 0,0 to x,y)
	...
	* @param lr is (x,y) of the lower right corner of the rectangle */
	...
	long sumHelper(vector< vector< long >> summer, pair<int,int> ul, pair<int,int> lr);

	void statHelper(int x1, int y1, int x2, int y2, int plus);
